...
<p>Write an SQL query to <strong>delete</strong> all the duplicate emails, keeping only one unique email with the smallest <code style="background-color: rgb(20, 28, 32) !important; color: rgb(183, 198, 205) !important;">id</code>. Note that you are supposed to write a <code style="background-color: rgb(20, 28, 32) !important; color: rgb(183, 198, 205) !important;">DELETE</code> statement and not a <code style="background-color: rgb(20, 28, 32) !important; color: rgb(183, 198, 205) !important;">SELECT</code> one.</p>
